...
export function AdminDashboard() {
  ...
  return (
    <div className="admin-dashboard flex h-screen overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 lg:static dashboard-sidebar w-64 flex flex-col shadow-lg z-30 transition-transform duration-300 lg:translate-x-0 ${
